 ...
 *
 */
public class IdWorkerAlgorithm {
    ...
    public IdWorkerAlgorithm() {
        this(1344322705519L);
    }

    public IdWorkerAlgorithm(long idepoch) {
        this(r.nextInt((int) maxWorkerId), r.nextInt((int) maxDatacenterId), 0, idepoch);
    }

    public IdWorkerAlgorithm(long workerId, long datacenterId, long sequence) {
        this(workerId, datacenterId, sequence, 1344322705519L);
    }

    //
    public IdWorkerAlgorithm(long workerId, long datacenterId, long sequence, long idepoch) {
