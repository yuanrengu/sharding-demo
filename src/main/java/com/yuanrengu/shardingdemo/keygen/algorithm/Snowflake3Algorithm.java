...
/**
 * from https://github.com/downgoon/snowflake
 */
public class Snowflake3Algorithm {
     ...
     * elapsed since the {@link #epoch} given by users on {@link Snowflake3Algorithm}
     ...
     */
    public Snowflake3Algorithm(long datacenterId, long workerId) {
    ...
    public static void main(String[] args) {
        Snowflake3Algorithm snowflake = new Snowflake3Algorithm(2, 5);
        for (int i = 0; i < 20; i++) {
